...
class ElevenLabsSpeaker(Speaker):
    ...
    def say(self, text: str) -> None:
        ...
        if cache_path and cache_path.is_file():
            play_pcm16_bytes(cache_path.read_bytes(), self.sample_rate, on_chunk=on_chunk, silent=self.silent)
            return
        ...
        played = play_pcm16_stream(stream, self.sample_rate, on_chunk=on_chunk, silent=self.silent)
